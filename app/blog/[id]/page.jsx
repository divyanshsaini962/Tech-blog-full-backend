      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="flex items-center justify-center gap-3">
            <span className="text-primeColor">{blogDetails?.category}</span>
                  ...
                  (paragraph, pIndex) => (
                    <div key={pIndex}>
                      {pIndex ===
                        ...
                        <blockquote className="border-l-4 border-primeColor border-spacing-6 italic mb-5">
          ...
          <>
            {blogDetails.comments.map((comment) => (
              <div key={comment._id} className="flex gap-3 py-5 items-center">
                ...
                <BsTrash onClick={() => handleDeleteComment(comment._id)} cursor="pointer" 
