  ...
  return (
    <div className='container py-2 h-16 flex items-center justify-between'>
        ...
        <ul className='flex items-center gap-3'>
            <li>
                <Link href="/blog" className={ pathname === '/blog' ? "text-primeColor font-bold" : ""}>Blog</Link>
            </li>

            {
                session?.user ? (
                    <>
                        <li>
                            <Link href="/create-blog"  className={ pathname === '/create-blog' ? "text-primeColor font-bold" : ""}>Create</Link>
                        </li>
                        <li>
                            <div className='relative'>
                                ...
                                {showDropdown && (
                                    <div className='absolute top-0 right-0 bg-primeColorLight p-5'>
                    ...
                    <>
                        <li>
                            <Link href="/login"  className={ pathname === '/login' ? "text-primeColor font-bold" : ""}>Log In</Link>
                        </li>
                        <li>
                            <Link href="/signup"  className={ pathname === '/signup' ? "text-primeColor font-bold" : ""}>Sign Up</Link>
                        </li>
                    </>
                )
            }
